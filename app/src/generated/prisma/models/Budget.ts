...
export type BudgetWhereInput = {
  ...
  monthlyAmountCents?: Prisma.IntFilter<"Budget"> | number
  anchorDay?: Prisma.IntFilter<"Budget"> | number
...
export type BudgetScalarWhereWithAggregatesInput = {
  ...
  monthlyAmountCents?: Prisma.IntWithAggregatesFilter<"Budget"> | number
  anchorDay?: Prisma.IntWithAggregatesFilter<"Budget"> | number
...
export type BudgetOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "monthlyAmountCents" | "anchorDay" | "updatedAt", ExtArgs["result"]["budget"]>
...
export interface BudgetDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const budgetWithUserIdOnly = await prisma.budget.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Budgets and only return the `userId`
   * const budgetWithUserIdOnly = await prisma.budget.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Budgets and only return the `userId`
   * const budgetWithUserIdOnly = await prisma.budget.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface BudgetFieldRefs {
  ...
  readonly monthlyAmountCents: Prisma.FieldRef<"Budget", 'Int'>
  readonly anchorDay: Prisma.FieldRef<"Budget", 'Int'>
